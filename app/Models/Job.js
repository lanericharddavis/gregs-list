            ...
            <div class="col-md-4 mb-3">
                <div class="card shadow">
                    <img class="card-img-top"
                        src="https://thumbs.dreamstime.com/b/job-text-red-grungy-lines-stamp-vintage-rubber-209319118.jpg"
                        alt="">
                    <div class="card-body">
                    ...
                    <div class="px-3 pb-3 d-flex justify-content-between">
                        <button type="button" class="btn btn-danger" onclick="app.jobsController.delete('${this.id}')> Delete </button>
